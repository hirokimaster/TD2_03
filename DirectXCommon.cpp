...
void DirectXCommon::CreateSwapChain() {
	...
	HRESULT hr = dxgiFactory_->CreateSwapChainForHwnd(commandQueue_.Get(), winApp_->GetHwnd(), &swapChainDesc,
...
void DirectXCommon::CreateRenderTargetView() {
	...
	HRESULT hr = device_->CreateDescriptorHeap(&rtvDescriptorHeapDesc, IID_PPV_ARGS(&rtvHeap_));
