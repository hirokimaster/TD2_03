...
//void Model::InitializeObj(ModelData modelData)
//{
//	// VertexResource
...
//	// 使用するリソースのサイズは頂点サイズ
//	objVertexBufferView_.SizeInBytes = UINT(sizeof(VertexData) * modelData.vertices.size());
//	// 1頂点あたりのサイズ
...
//	// 描画。(DrawCall/ドローコール)。
//	DirectXCommon::GetCommandList()->DrawInstanced(UINT(Model::modelData_.vertices.size()), 1, 0, 0);
//}
